...
urlpatterns = [
    ...
    path(
        "categories/update/<int:pk>/", adminapp.ProductCategoryUpdateView.as_view(), name="category_update"
    ),
    path(
        "categories/delete/<int:pk>/", adminapp.ProductCategoryDeleteView.as_view(), name="category_delete"
    ),
    path(
